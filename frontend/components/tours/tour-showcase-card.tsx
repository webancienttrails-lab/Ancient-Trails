...
export function TourShowcaseCard({
  ...
  className,
  ctaLabel = "Book Now",
  difficultyLabel = "Moderate Activity Level",
  durationLabel,
  ...
  return (
    ...
    >
      ...
      <div className="px-4 pb-2 pt-4 sm:px-5">
        <h3 className="line-clamp-2 font-heading text-[20px] font-bold leading-[1.06] tracking-normal text-secondary sm:text-[20px]">
          {title}
        </h3>
        ...
        <div className="mt-2 py-2 flex flex-nowrap items-center justify-between gap-2.5 border-t border-[#d6d1cb]">
          <span className="min-w-0 flex-1 font-sans">
            ...
            <strong className="mt-0 block truncate font-sans text-[22px] font-semibold leading-none text-primary sm:text-[24px]">
              {priceLabel}
            </strong>
          </span>
          <Button

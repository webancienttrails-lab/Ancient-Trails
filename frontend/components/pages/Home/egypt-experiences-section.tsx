  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 flex items-end justify-between gap-4 p-5 text-white">
        ...
        <span className="grid size-8 shrink-0 place-items-center rounded-full border border-white/70 text-white transition-colors group-hover:bg-white group-hover:text-primary">
...
export function EgyptExperiencesSection() {
  return (
    <section className="relative overflow-hidden bg-background py-20">
      <div className="mx-auto grid w-full max-w-[1300px] gap-8 px-5 sm:px-8 lg:grid-cols-[848px_356px]">
        <div>
          ...
          <div className="mt-5 grid items-center gap-3 sm:grid-cols-[repeat(4,150px)_176px]">
            ...
            <button
              type="button"
              className="flex h-[92px] items-center justify-center gap-4 rounded-[7px] bg-white px-0 text-description transition-colors hover:text-primary cursor-pointer"
            >
        ...
        <aside className="flex h-full flex-col items-center justify-between text-center">
          <Button className="mb-14 h-11 min-w-[270px] justify-between gap-8 px-6 font-normal ">
          ...
          <p className="mt-6 max-w-[285px] font-heading text-[18px] leading-[1.55] text-secondary">
            ...
            stranded in Cairo since hotel was a little remote from city (new and
            old Cairo).
          </p>

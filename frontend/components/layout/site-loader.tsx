...
export function LoaderScreen() {
  return (
    <main className="grid min-h-screen place-items-center bg-[#fbf7f3]">
...
export function SiteLoader() {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className={`fixed inset-0 z-[2147483647] grid place-items-center bg-[#fbf7f3] transition-opacity duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${
